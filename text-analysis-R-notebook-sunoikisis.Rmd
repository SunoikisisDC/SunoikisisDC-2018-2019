...
```{r}
dialogue.v <- grep('"\\w.*?"', novel.lines.v) # grep is another regex function

novel.lines.v[dialogue.v][1:10] # check your work by finding all the dialogue lines in novel.lines.v
```
